...
<table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="background:#FAFAF9;padding:32px 16px;"><tr><td align="center">
      ...
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0">
        ...
        <tr><td style="font-size:15px;line-height:1.6;color:#0A0A0A;">
          ...
          <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background:#FAFAF9;border:1px solid #E5E5E5;border-radius:12px;padding:14px;margin:16px 0;"><tr><td style="font-size:13px;color:#525252;line-height:1.7;">
            <strong style="color:#0A0A0A;">À noter :</strong> les <em>formations avancées</em> et le <em>coaching live mensuel</em> sont réservés aux abonnés <strong>Plan Progress</strong> (6 mois) et <strong>Plan Master</strong> (1 an). Tu pourras les débloquer en passant à l'un de ces plans avant la fin de ton mois.
          </td></tr></table>
  ...
  const text = [
    ...
    ``,
    `À noter : les formations avancées et le coaching live mensuel sont réservés aux Plans Progress (6 mois) et Master (1 an).`,
    ``,
