...
export function EmptyState({
  ...
  return (
    ...
    >
      {icon && (
        <span className="flex h-20 w-20 items-center justify-center rounded-full bg-[var(--secondary)]/50 text-[var(--muted-foreground)] shadow-sm ring-1 ring-[var(--border)]">
          {icon}
        </span>
      )}
      <h3 className="mt-6 font-display text-xl font-bold tracking-tight text-[var(--foreground)] sm:text-2xl">
        {title}
      </h3>
