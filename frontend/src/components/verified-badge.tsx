...
/**
 * Badge "Membre certifié" — forme dentelée 9 branches style Twitter/Facebook,
 * en bleu ciel deep #2563EB avec check blanc (harmonie chromatique avec
 * le reste de l'identité Club). #2563EB est choisi plutôt que le bleu
 * ciel clair #60A5FA pour garantir un contraste AA du check blanc sur le
 * badge à très petite taille (h-3 w-3 typique).
 *
 * Le SVG est viewBox 22×22. Donne-lui une taille via la className (h-x w-x).
 */
export function VerifiedBadge({
  className,
  ariaLabel = 'Membre certifié',
}: {
  className?: string
  ariaLabel?: string
}) {
