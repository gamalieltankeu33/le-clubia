...
const POSTS: PostItem[] = [
  ...
  },
  {
    ...
    avatar: '/landing/avatars/ak.png', // Reusing for variety if needed, but I have avatar_moussa.png? Wait, I named it km.png in cp. 
    bg: '#1e293b',
    likes: 67,
    comments: 19,
    isVerified: true,
  },
  {
    ...
    avatar: '/landing/avatars/zs.png', // Reusing 
    bg: '#e11d48',
    likes: 88,
    comments: 21,
  },
