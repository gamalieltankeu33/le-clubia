...
const POSTS: PostItem[] = [
  ...
  },
  {
    ...
    body: "Ma méthode pour recycler 1 vidéo YouTube en 10 Shorts avec l'IA en moins de 15 minutes. Qui veut le guide complet ?",
    avatar: '/landing/avatars/fn.png',
    bg: '#7c3aed',
    likes: 112,
    comments: 45,
  },
  {
    ...
    initials: 'AW',
    role: 'Data Scientist',
    body: "Est-ce que quelqu'un a testé les nouveaux modèles de Fine-tuning sur OpenAI ? Les coûts ont chuté, c'est le moment d'y aller.",
    avatar: '/landing/avatars/ak.png',
    bg: '#0f172a',
    likes: 28,
    comments: 4,
  },
  {
    ...
    initials: 'ST',
    role: 'UI/UX Designer',
    body: "Figma AI + Adobe Firefly : mon workflow design a été divisé par 3 en termes de temps de production. Un vrai bonheur.",
    avatar: '/landing/avatars/zs.png',
    bg: '#4338ca',
    likes: 51,
    comments: 12,
  ...
  },
  {
    ...
    initials: 'IB',
    role: 'Expert SEO IA',
    body: "Le SGE arrive bientôt en France. J'ai préparé une checklist pour ne pas perdre son trafic Google. Dispo en DM.",
    avatar: '/landing/avatars/km.png',
    bg: '#15803d',
    likes: 94,
    comments: 38,
  },
  {
    ...
    body: "Je viens de finir la formation sur Claude. Ma plume n'a jamais été aussi précise. Le Club IA est indispensable.",
    avatar: '/landing/avatars/fn.png',
    bg: '#be185d',
    likes: 47,
    comments: 9,
  },
  {
    ...
    body: "Mon top 5 des prompts pour la génération d'images ultra-réalistes sur Flux.1. C'est du solide.",
    avatar: '/landing/avatars/ak.png',
    bg: '#0369a1',
    likes: 62,
    comments: 15,
  ...
  },
  {
    ...
    body: "Nouveau record : j'ai généré 30 posts Instagram en 1h avec une cohérence visuelle parfaite via Canva Magic Studio.",
    avatar: '/landing/avatars/zs.png',
    bg: '#e11d48',
    likes: 88,
    comments: 21,
  },
  {
    ...
    body: "Qui utilise Perplexity pour ses fiches produits ? J'ai trouvé un prompt qui réduit le temps de rédaction de 80%.",
    avatar: '/landing/avatars/ak.png',
    bg: '#0369a1',
    likes: 31,
    comments: 7,
  },
  {
    ...
    body: "Le workshop d'hier sur les agents IA était incroyable. Hâte de mettre en place mon premier assistant autonome.",
    avatar: '/landing/avatars/zs.png',
    bg: '#be185d',
    likes: 45,
    comments: 11,
  ...
  },
  {
    ...
    body: "Est-ce que certains d'entre vous utilisent Magnific AI pour l'upscaling ? Les résultats sont bluffants pour le print.",
    avatar: '/landing/avatars/km.png',
    bg: '#4f46e5',
    likes: 29,
    comments: 5,
  },
  {
    ...
    initials: 'YH',
    role: 'Copywriter IA',
    body: "Claude 3.5 Sonnet est officiellement mon nouveau meilleur ami pour le copywriting. La finesse de l'écriture est imbattable.",
    avatar: '/landing/avatars/fn.png',
    bg: '#7c3aed',
    likes: 73,
    comments: 18,
