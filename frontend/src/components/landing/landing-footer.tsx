      ...
      <div className="mx-auto max-w-6xl px-5 sm:px-6 lg:px-8 py-16">
        <div className="grid gap-12 md:grid-cols-4 md:gap-8">
          ...
          <div className="md:col-span-1">
            <BrandLogo size="xl" variant="primary" display="mark" showSignature />
          ...
          <FooterColumn title="Suis-nous">
            <SocialLink
              href="https://www.instagram.com/gamaliel_tankeu"
              label="Instagram"
              icon={<InstagramGlyph />}
            />
            <SocialLink
              href="https://www.tiktok.com/@gamaliel_tankeu"
              label="TikTok"
              icon={<TiktokGlyph />}
            />
            <SocialLink
              href="https://www.youtube.com/@GamalielTankeu"
              label="YouTube"
              icon={<YoutubeGlyph />}
            />
            <SocialLink
              href="https://www.facebook.com/gamalieltankeu01/"
              label="Facebook"
              icon={<FacebookGlyph />}
            />
          </FooterColumn>
