      ...
      <AnimatePresence>
        {action && (
          <motion.button
            ...
            className="fixed right-5 z-[41] flex h-14 w-14 items-center justify-center rounded-full bg-[var(--emerald)] text-[var(--noir)] shadow-xl shadow-[var(--emerald)]/40 ring-0 transition-shadow active:ring-4 active:ring-[var(--emerald)]/30 lg:hidden touch-manipulation"
            style={{
